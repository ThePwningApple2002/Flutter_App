                    ...
                    BlocBuilder<CategoryBloc, CategoryState>(
                      builder: (context, categoryState) {
                        if (categoryState is CategoriesLoadedState) {
                          try {
                            final recommendedCategory = categoryState.categories
                                .firstWhere(
                                    (category) =>
                            ...
                            context.read<SongBloc>().add(
                                LoadSongsEvent(category: recommendedCategory));
                            ...
                            return SizedBox(
                              ...
                              child: BlocBuilder<SongBloc, SongState>(
                                builder: (context, songState) {
                                  if (songState is SongsLoadingState) {
                                    return const Center(
                                      child: CircularProgressIndicator(),
                                    );
                                  } else if (songState is SongsLoadedState) {
                                  ...
                                  } else if (songState is SongsErrorState) {
                                    return Center(
                                      child: Text(
